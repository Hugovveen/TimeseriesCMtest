...
# Job Jobse
ARTIST_ID = 14023591
ARTIST_NAME = "Job Jobse"

SINCE = "2025-06-09"
UNTIL = "2026-06-09"
SLEEP_SECONDS = 1

# keep outputs separate from the Len Faki probe
RAW_DIR = Path("chartmetric_job_jobse_history_raw")
SUMMARY_CSV = Path("job_jobse_timeseries_probe_summary.csv")
